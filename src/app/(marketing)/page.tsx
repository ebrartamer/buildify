...
import FrameToCode from "@/components/frametocodeanim/page";
          ...
          <div className="flex flex-col items-center justify-center py-20 h-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
              <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                Fikirlerini gerçeğe yansıt
              </h1>
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                Buildfy ile hayalinizdeki web sitesini oluşturun ve dünyaya
                açılın. İster kişisel, ister kurumsal, isterseniz de e-ticaret
                sitenizi oluşturun.
              </p>
            ...
            <div className="relative flex items-center py-10 md:py-20 w-full">
              <div className="-m-2 w-full rounded-xl p-2 ring-1 ring-inset ring-foreground/20 lg:-m-4 lg:rounded-2xl bg-opacity-50 backdrop-blur-3xl">
                <FrameToCode />
